...
@section('page-title')
    {{ __("Pagefy | m link para todas as suas páginas") }}
@endsection
...
@section('content')
    <div class="w-full flex flex-col items-center justify-center py-20 px-5">
        <div class="text-center">
            <h1 class="font-bold text-5xl text-transparent bg-clip-text bg-gradient-to-r from-primary-800 to-primary-600">{{ __("Um link para todas as suas páginas!") }}</h1>
            <p class="text-xl mt-5">{{ __("Crie uma página para anexar todas os seus links, com dominio personalizado! Totalmente gratuíto  ") }}</p>
        </div>
        <div class="container flex items-center justify-center mt-10">
            <div class="card-carousel-container w-full">
                ...
                <a href="#" class="visuallyhidden card-controller">Carrosell</a>
            </div>
        </div>
        <a href="{{ route('register') }}" class="mt-10 inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-primary-600 to-secondary-600 font-semibold font-normal text-white transition hover:from-primary-600 hover:to-primary-600 focus:outline-none disabled:opacity-25 px-4 py-2 text-xl w-max">
            {{ __("Crie a sua página agora mesmo") }}
        </a>
    ...
    <div class="w-full flex flex-col items-center justify-center bg-white py-20 px-5">
        <h2 class="font-bold text-3xl text-transparent bg-clip-text bg-gradient-to-r from-primary-800 to-primary-600">Projeto open source</h2>
        <p class="mt-10 text-xl">O pagefy é um projeto open source baseado no repositório iBio, originalmente projetado por <a href="https://github.com/saeedvaziry/ibio" class="text-primary-600" target="_blank">Saeed Vaziry</a> </p>
    </div>
@endsection
